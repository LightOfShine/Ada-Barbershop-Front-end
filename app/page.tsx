            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-[44px] px-4 pr-11 border border-[#E5E7EB] rounded-[8px] text-[13px] text-slate-900 bg-white placeholder:text-[#9CA3AF] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
                  required
                />
                {/* Show Password Icon */}
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center px-3 text-[#9CA3AF] hover:text-[#4B5563] transition-colors"
